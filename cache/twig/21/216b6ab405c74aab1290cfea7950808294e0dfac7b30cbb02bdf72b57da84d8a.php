...
class __TwigTemplate_cadf74ff9b768865380f59281f5efd21669572046480967fc8766790f6738f0c extends \Twig\Template
{
...
";
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["tax"] => $context["value"]) {
                ...
                echo $context["value"];
                echo " ";
                echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate($this->env, "TOPICS");
                echo "\" href=\"";
...
{% endif %}
", "partials/taxonomylist.html.twig", "/usr/share/nginx/html/user/themes/receptar/templates/partials/taxonomylist.html.twig");
    }
}
